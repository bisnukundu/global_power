<x-dashboard-layout>
    ...
    <div class="grid w-full mt-3">
        ...
        <form action="{{ route('naturl_resource.update',$edit_natur_resourch->id) }}" method="POST">
            @csrf
            @method('put')
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <label for="oil_production" class="block text-sm font-medium text-gray-700">Oil
                                Production</label>
                            <input required value="{{$edit_natur_resourch->oil_production}}" type="number" name="oil_production"
                                id="oil_production"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <label for="oil_consumption" class="block text-sm font-medium text-gray-700">Oil
                                Consumption</label>
                            <input required value="{{ $edit_natur_resourch->oil_consumption }}" type="number" name="oil_consumption"
                                id="oil_consumption"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-6  sm:col-span-3">
                            <label for="oil_proven_reserves" class="block text-sm font-medium text-gray-700">Oil Proven
                                Reserves</label>
                            <input required value="{{ $edit_natur_resourch->oil_proven_reserves }}" type="number"
                        ...
                        <div class="col-span-6">
                            ...
                            <textarea value="" name="airpower_notes" id="airpower_notes"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                cols="30" rows="10">
                                {{ $edit_natur_resourch->notes }}
                                </textarea>
