<x-dashboard-layout>
    ...
    <div class="grid w-full mt-3">
        ...
        <form action="{{ route('landforces.store') }}" method="POST">
            @csrf
                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input required value="{{old('tanks')}}" type="number" name="tanks" id="tanks"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            @error('tanks')
                                <x-error-show>
                                    {{ $message }}
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input required value="{{old('armored_vehicles')}}" type="number" name="armored_vehicles" id="armored_vehicles"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-6  sm:col-span-3">
                            ...
                            <input required value="{{old('self_propelled_artillery')}}" type="number" name="self_propelled_artillery" id="self_propelled_artillery"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-6  sm:col-span-3">
                            ...
                            <input required value="{{old('towed_artillery')}}" type="number" name="towed_artillery" id="towed_artillery"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-6  sm:col-span-6">
                            ...
                            <input required value="{{old('rocket_projectors')}}" type="number" name="rocket_projectors" id="rocket_projectors"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
