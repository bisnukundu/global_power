<x-dashboard-layout>
    ...
    <div class="grid w-full mt-3">
        ...
        <form action="{{ route('naval_forces.store') }}" method="POST">
            @csrf
                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input required value="{{old('total_assets')}}" type="number" name="total_assets" id="total_assets"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            @error('total_assets')
                                <x-error-show>
                                    {{ $message }}
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input required value="{{old('aircraft_carriers')}}" type="number" name="aircraft_carriers" id="aircraft_carriers"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-6  sm:col-span-3">
                            ...
                            <input required value="{{old('helicopter_carriers')}}" type="number" name="helicopter_carriers" id="helicopter_carriers"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-6  sm:col-span-3">
                            ...
                            <input required value="{{old('destroyers')}}" type="number" name="destroyers" id="destroyers"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-6  sm:col-span-6">Frigates
                            ...
                            <input required value="{{old('frigates')}}" type="number" name="frigates" id="frigates"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-6  sm:col-span-3">
                            ...
                            <input required value="{{old('corvettes')}}" type="number" name="corvettes" id="corvettes"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-6  sm:col-span-3">
                            ...
                            <input required value="{{old('submarines')}}" type="number" name="submarines" id="submarines"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-6  sm:col-span-3">
                            ...
                            <input required value="{{old('patrol_vessels')}}" type="number" name="patrol_vessels" id="patrol_vessels"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-6  sm:col-span-3">
                            ...
                            <input required value="{{old('mine_warfare')}}" type="number" name="mine_warfare" id="mine_warfare"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-6">
                            ...
                            <textarea value="{{old('naval_forces_notes')}}" name="naval_forces_notes" id="naval_forces_notes"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
