<x-dashboard-layout>
    ...
    <div class="grid w-full mt-3">
        ...
        <form action="{{ route('geography.store') }}" method="POST">
            @csrf
                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input required value="{{old('square_land_area')}}" type="number" name="square_land_area" id="square_land_area"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input required value="{{old('coastline_coverage')}}" type="number" name="coastline_coverage" id="coastline_coverage"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-6  sm:col-span-3">
                            ...
                            <input required value="{{old('shared_borders')}}" type="number" name="shared_borders" id="shared_borders"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-6  sm:col-span-3">
                            ...
                            <input required value="{{old('waterways_usable')}}" type="number" name="waterways_usable" id="waterways_usable"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-6">
                            ...
                            <textarea value="{{old('geography_note')}}" name="geography_note" id="geography_note"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
