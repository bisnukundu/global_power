    ...
    <div class="h-full bg-gray-200">
        ...
        <div class="container mx-auto mt-2 md:p-20 shadow-sm rounded-sm bg-white">
            ...
            <div class="bg-white shadow-sm mt-5 py-4 rounded-md p-8">
                ...
                <div class="grid gap-2 grid-cols-1  mb-36 shadow-md lg:p-20 rounded-md md:grid-cols-3">
                ...
                <div class="grid gap-2 grid-cols-1 mb-36 shadow-md rounded-md lg:p-20 md:grid-cols-3">
                ...
                <span class="w-20 mb-3 md:mb-0 h-1 block mx-auto  bg-red-400"></span>
                <div class="grid mb-36 shadow-md lg:p-20 rounded-md gap-2 grid-cols-1 md:grid-cols-3">
            ...
            <div class="px-10">
                ...
                <p class="text-gray-500 mt-5"><b class="text-black">NAVAL FORCES - </b>{{$country->navalForces->notes}}</p>
                <p class="text-gray-500 mt-5"><b class="text-black">AIRPOWER - </b>{{$country->airPower->notes}}</p>
                <p class="text-gray-500 mt-5"><b class="text-black">LANDFORCES - </b>{{$country->landforces->notes}}</p>
                <p class="text-gray-500 mt-5"><b class="text-black">NATURAL RESOURCES - </b>{{$country->naturalResources->notes}}</p>
                <p class="text-gray-500 mt-5"><b class="text-black">LOGISTICS - </b>{{$country->logistic->notes}}</p>
                <p class="text-gray-500 mt-5"><b class="text-black">FINANCIALS - </b>{{$country->financials->notes}}</p>
                <p class="text-gray-500 mt-5"><b class="text-black">GEORGRAPHY - </b>{{$country->georgraphy->notes}}</p>
            </div>
        </div>
    </div>
</x-frontend.layout>
